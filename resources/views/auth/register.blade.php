...
@section('title', 'Daftar Akun – BukberYuk')
        ...
        <div class="bg-[#1e293b] rounded-2xl shadow-2xl border border-slate-700/50 overflow-hidden">
            ...
            <div class="relative bg-primary/5 border-b border-slate-700/50 px-8 py-8 text-center overflow-hidden">
                ...
                <div class="relative inline-flex items-center justify-center w-14 h-14 bg-primary/20 rounded-xl mb-4">
                    <span class="material-symbols-outlined filled text-primary" style="font-size:28px;">person_add</span>
                </div>
                <h1 class="text-2xl font-extrabold text-white">Buat Akun Baru</h1>
                <p class="mt-1 text-slate-400 text-sm">Daftarkan diri untuk mengelola dashboard</p>
            </div>

            {{-- Form --}}
            <form action="/register" method="POST" class="px-8 py-8 space-y-5">
                @csrf
                ...
                {{-- Name --}}
                <div>
                    <label for="name" class="block text-sm font-semibold text-slate-300 mb-2">Nama</label>
                    <div class="relative">
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-1/2 -translate-y-1/2 material-symbols-outlined text-slate-400" style="font-size:20px;">lock</span>
                ...
                <p class="text-center text-sm text-slate-500">
                    Sudah punya akun?
                    <a href="/login" class="text-primary hover:underline font-semibold">Masuk sekarang</a>
                </p>
            </form>
        </div>
